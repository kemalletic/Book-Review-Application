...
import { getUserProfile, updateUserProfile, getUserReviews } from '../services/auth';
import { useNavigate } from 'react-router-dom';
import { Link as RouterLink } from 'react-router-dom';
import { bookmarkService, BookmarkedBook } from '../services/bookmark';
...
const Profile: React.FC = () => {
  ...
  const handleRemoveBookmark = async (bookId: number) => {
    try {
      await bookmarkService.toggleBookmark(bookId);
              ...
              <Paper elevation={3}>
                ...
                <TabPanel value={activeTab} index={0}>
                  {reviewsLoading ? (
                    ...
                    <Box sx={{ textAlign: 'center', color: 'error.main', py: 3 }}>
                      <Typography variant="body1">{reviewsError}</Typography>
                    </Box>
                          ...
                          >
                            <ListItemAvatar>
                              <Avatar
                                ...
                                onClick={() => handleImageClick(review.userAvatar)}
                              />
                            </ListItemAvatar>
                            <ListItemText
                              primary={
                ...
                <TabPanel value={activeTab} index={1}>
                  {bookmarksLoading ? (
                    ...
                    <Box sx={{ textAlign: 'center', color: 'error.main', py: 3 }}>
                      <Typography variant="body1">{bookmarksError}</Typography>
                    </Box>
